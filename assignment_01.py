...
Original file is located at
    https://colab.research.google.com/drive/1-OaL0HysMQHM7TmTDY0iVG_p38yKZfQq
...
hour=num//3600 #hour=60*60(1hr=60min and 1min=60sec)
sec1=num%3600 #store the reminder
minutes= sec1//60
seconds=sec1%60 #reminder of reminder(1st case) will be seconds
...
wh= int(input("Enter the work hour "))
if 0<=wh<=168:
    if wh<=40:
        salary=200*wh
    else:
        salary=8000+((wh-40)*300) #over 40 hours
else:
    if wh<0:
        salary='Hour cannot be nagative'
    else:
        salary='Impossible to work more than 168 hours weekly'
print(salary)
...
temperature_F= int(input("Enter the temperature "))
temperature_C=((temperature_F-32)*0.56)
print(temperature_C, "degrees C")
...
distance_in_m= int(input("Enter a value for distance "))
distance_in_km= distance_in_m/1000
time_in_s= int(input("Enter a value for time "))
time_in_h= time_in_s/3600
velocity= distance_in_km/time_in_h
print(velocity, "km/h")
if (velocity<60):
...
previous_total=((canvases*120) + (paint_tubes*75))
print("Previous total:",previous_total)
if(0<=previous_total<=299):
    new_total_after_discount= previous_total-0
    print("New total after discount:",new_total_after_discount)
elif(300<=previous_total<=499):
    new_total_after_discount= previous_total-10
    print("New total after discount:",new_total_after_discount)
elif(500<=previous_total<=749):
    new_total_after_discount= previous_total-20
    print("New total after discount:",new_total_after_discount)
elif(750<=previous_total<=999):
    new_total_after_discount= previous_total-50
    print("New total after discount:",new_total_after_discount)
elif(previous_total>=1000):
    new_total_after_discount= previous_total-150
    print("New total after discount:",new_total_after_discount)